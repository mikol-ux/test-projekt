...
const BlogCard: React.FC<BlogCardData> = ({ number, title, tag, image, subtitle }) => {
	return (
		<div className="group md:max-w-[25em] min-w-[25em] border hover:cursor-pointer hover:scale-105 transition-all flex flex-col flex-1 border-gray-900 rounded-lg h-full shadow-lg p-2 md:p-4">
			{/* Card Content */}
			<div className="flex-grow mt-2 md:mt-4 mb-auto">
