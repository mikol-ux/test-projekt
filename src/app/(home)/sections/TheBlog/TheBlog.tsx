...
const TheBlog: FC = () => {
	...
	const accordions = [
		...
		{ title: "You can predit who wins the next cup", category: "Sports", img: "https://picsum.photos/200/300/?blur=", createdAt: "2024", content: "Predicting the winner of the next major sports event has always been a topic of great interest among fans and analysts alike. With the advent of advanced data analytics and machine learning algorithms, it is now possible to analyze vast amounts of data to make more accurate predictions. Factors such as team performance, player statistics, historical data, and even weather conditions can be taken into account to forecast the outcome of a game. While no prediction can be 100% accurate, these technologies have significantly improved the chances of making correct predictions, adding a new dimension to the excitement of sports." },
		...
		{ title: "AI can take your job? LOL!", category: "Tech", img: "https://picsum.photos/200/300/?blur=3", createdAt: "2024", content: "Artificial Intelligence (AI) has been a topic of great interest and debate for many years. With advancements in technology, AI has become more sophisticated and capable of performing tasks that were once thought to be exclusive to humans. However, the question remains: can AI take your job? While AI can automate certain tasks and improve efficiency, it is unlikely to completely replace human jobs. Instead, AI is more likely to augment human capabilities and create new opportunities for growth and innovation." },
	];
