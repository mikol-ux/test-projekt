		...
		<section className="tpk-contained">
			<div ref={sectionRef} className="min-h-screen text-white p-8">
				<div className="w-full text-center">
					<SolidBtn href="#x" className="block w-fit mx-auto mb-10 uppercase cursor-default">How It Works</SolidBtn>
						...
						<div key={index} className="relative mb-16">
							<div className={`flex flex-col justify-center items-center md:gap-16 ps-8 md:ps-0 ${index % 2 !== 0 ? 'md:flex-row-reverse' : 'md:flex-row'} relative`}>
								...
								<div className="timeline-card basis-6/12 2xl:basis-4/12">
									<p className="text-sky-blue tpk-text-md step-number font-normal mb-2 transition-colors duration-300">
										{step.step}
									</p>
									<h3 className="step-title tpk-text-lg font-normal mb-3 text-black dark:text-white transition-colors duration-300">
										{step.title}
									</h3>
