		...
		<footer className="tpk-contained">
			...
			<div className="block md:grid md:grid-cols-6 grid-flow-col gap-4">
				<div className="md:col-span-4">
					...
					<Link
						href="#x"
						className="block text-center p-3 border-[0.5px] border-muted-4 dark:border-white text-black dark:text-white hover:bg-black dark:hover:bg-white hover:text-white dark:hover:text-black focus:bg-black focus:text-white dark:focus:bg-white dark:focus:text-black">
